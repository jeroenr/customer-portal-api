...
(function() {
  var ApiKeyAuthorization, TokenAuthorization, PasswordAuthorization, SwaggerApi, SwaggerAuthorizations, SwaggerHttp, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource,
  ...
  TokenAuthorization = (function() {
    ...
    TokenAuthorization.prototype.timestamp = null;

    TokenAuthorization.prototype.salt = null;

    TokenAuthorization.prototype.password = null;

    function TokenAuthorization(timestamp, salt, password) {
    ...
    TokenAuthorization.prototype.apply = function(obj, authorizations) {
      obj.headers["Authorization"] = "Token token=\"" + CryptoJS.SHA1(this.timestamp + this.salt + this.password) + "\", timestamp=\"" + this.timestamp + "\"";
      return true;
    };
